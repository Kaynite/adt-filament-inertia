...
use App\Filament\Resources\TeamGroupResource\Pages;
...
class TeamGroupResource extends Resource
{
    ...
    {
        return [
            'index' => Pages\ListTeamGroups::route('/'),
            'create' => Pages\CreateTeamGroup::route('/create'),
            'edit' => Pages\EditTeamGroup::route('/{record}/edit'),
        ];
    }
}
